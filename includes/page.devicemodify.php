...
<h2><?php echo ("Modification d'un enregistreur")?></h2>
...
if ( !empty($_POST['send']) && $valid === true ) {
	...
	$d->loadDataFromID() ;
	?>
	<form name="deviceForm" method="POST" action="page-devicemodify">
		<fieldset>
		<legend><?php echo _('Enregistreur')." : ".$d->getData('device_name');?></legend>

		<input name="ID" type="hidden" value="<?php echo $d->getID() ?>" />
